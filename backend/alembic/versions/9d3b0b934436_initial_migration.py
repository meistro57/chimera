...
Revision ID: 9d3b0b934436
Revises: 
Create Date: 2025-10-07 22:14:07.209391
...
def upgrade() -> None:
    ...
    sa.Column('default_parameters', postgresql.JSONB(astext_type=Text()), nullable=True),
    ...
    sa.Column('ai_participants', sa.ARRAY(sa.Text()), nullable=True),
    sa.Column('active_personas', postgresql.JSONB(astext_type=Text()), nullable=True),
